$(document).ready(function () {
    var searchHistoryField = $("#searchHistory");
    var searchForm = $("#search-field");
    var todaysWeatherField = $("#todaysWeather");
    var upcomingWeather = $("#upcomingWeather");
    var searchValue = $("#search-value");
    var apiKey = "8e5829741b80c7addeccf589e3b6d2d9";
    ...
    searchForm.submit(function (event) {
      ...
      searchHistoryField.append(searchTermDiv);
    ...
    function searchForCurrentCityWeather(city) {
      ...
      fetch(fullUrl)
        ...
        .then(function (data) {
          ...
          todaysWeatherField.append(cityNameDiv);
          todaysWeatherField.append(weatherImg);
          todaysWeatherField.append(tempDiv);
          todaysWeatherField.append(humidityDiv);
          todaysWeatherField.append(windDiv);
        });
    }
    function searchForFiveDayForecastWeather(city) {
      upcomingWeather.html("");
    ...
    function getUVIndex(lat, lon) {
      ...
      fetch(finalUrl)
        ...
        .then(function (data) {
          ...
          todaysWeatherField.append(uvIndexDiv);
        });
    }
